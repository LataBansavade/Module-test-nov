...
// loading the map and showing the location
const map = document.getElementById('map')
const mapDiv = document.createElement('div')
mapDiv.className = 'mapDiv'

mapDiv.innerHTML = `
    <iframe src="https://maps.google.com/maps?q=${latitude}, ${longitude}&output=embed" width="1350" height="650" frameborder="0" style="border:0"></iframe>
`
map.appendChild(mapDiv)



// calling an api to get weather data
